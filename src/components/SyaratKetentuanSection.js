...
const defaultTerms = {
  ...
  DetailSyaratKetentuan: [
    ...
    { children: [{ text: 'Selamat datang di Betulin, aplikasi perbaikan dan perawatan utilitas rumah yang dikelola oleh PT. Rumah Masa Kini. Dengan mengakses dan menggunakan aplikasi Betulin, Anda setuju untuk mematuhi syarat dan ketentuan yang tercantum di bawah ini. Jika Anda tidak setuju dengan syarat dan ketentuan ini, mohon untuk tidak menggunakan aplikasi kami.' }] },
